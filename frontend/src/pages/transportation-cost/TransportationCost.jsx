...
function TransportationCost(){
    const {isLoading, error,transportationCostData,transportCostUsage,total_transportation_cost} = useTC()
    ...
    return(
        ...
        <Gauge totalCost={budgetdata.totalCost} budget={budgetdata.budget} className={styles.chart4}/>
